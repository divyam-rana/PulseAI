"""
Fetches recent AI-related papers from arXiv and returns structured metadata as a Pandas DataFrame.

Queries core AI categories (cs.AI, cs.LG, cs.CL, cs.CV) from the past N days,
collecting titles, authors, abstracts, and metadata for ETL pipelines or analytics.
